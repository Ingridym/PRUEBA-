...
import proyecto.reto345.Repositorios.CategoriaRepository;
...
public class CategoriaServicios {
    ...
    public Categoria save(Categoria categoria){
        if(categoria.getId()==null){
            ...
            Optional<Categoria> categorial = metodosCrud.getCategoria(categoria.getId());
            if(categorial.toString().isEmpty()){
                return metodosCrud.save(categoria);
            }else{
                return categoria;
            }
